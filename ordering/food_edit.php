<?php 
	...
	if(isset($_POST['submit'])){
		...
		if($food_name && $price){
			mysql_query("UPDATE food SET food_name='$food_name' , food_code='$food_code' , price='$price', description='$description' WHERE food_id='$food_id'");
			header('Location: food_list.php?msg=update');
		}
	}else if(isset($_GET['food_id']) && $_GET['food_id']){
        $food_id=$_GET['food_id'];
        $query = mysql_query("SELECT * FROM `food` WHERE food_id='$food_id'");
...
?>
	...
	<h2 align="center">Update Food</h2>
